...
type MarketFilter_Operator int32

const (
	MarketFilter_GTE MarketFilter_Operator = 0
	MarketFilter_LTE MarketFilter_Operator = 1
)

// Enum value maps for MarketFilter_Operator.
var (
	MarketFilter_Operator_name = map[int32]string{
		0: "GTE",
		1: "LTE",
	}
	MarketFilter_Operator_value = map[string]int32{
		"GTE": 0,
		"LTE": 1,
	}
)

func (x MarketFilter_Operator) Enum() *MarketFilter_Operator {
	p := new(MarketFilter_Operator)
	*p = x
	return p
}

func (x MarketFilter_Operator) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MarketFilter_Operator) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_grpc_proto_market_proto_enumTypes[0].Descriptor()
}

func (MarketFilter_Operator) Type() protoreflect.EnumType {
	return &file_internal_grpc_proto_market_proto_enumTypes[0]
}

func (x MarketFilter_Operator) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MarketFilter_Operator.Descriptor instead.
func (MarketFilter_Operator) EnumDescriptor() ([]byte, []int) {
	return file_internal_grpc_proto_market_proto_rawDescGZIP(), []int{1, 0}
}

type MarketFilter_Line int32

const (
	MarketFilter_CLOSING MarketFilter_Line = 0
	MarketFilter_MAX     MarketFilter_Line = 1
)

// Enum value maps for MarketFilter_Line.
var (
	MarketFilter_Line_name = map[int32]string{
		0: "CLOSING",
		1: "MAX",
	}
	MarketFilter_Line_value = map[string]int32{
		"CLOSING": 0,
		"MAX":     1,
	}
)

func (x MarketFilter_Line) Enum() *MarketFilter_Line {
	p := new(MarketFilter_Line)
	*p = x
	return p
}

func (x MarketFilter_Line) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MarketFilter_Line) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_grpc_proto_market_proto_enumTypes[1].Descriptor()
}

func (MarketFilter_Line) Type() protoreflect.EnumType {
	return &file_internal_grpc_proto_market_proto_enumTypes[1]
}

func (x MarketFilter_Line) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MarketFilter_Line.Descriptor instead.
func (MarketFilter_Line) EnumDescriptor() ([]byte, []int) {
...
type MarketSearchRequest struct {
	...
	Filters        []*MarketFilter       `protobuf:"bytes,2,rep,name=filters,proto3" json:"filters,omitempty"`
...
func (x *MarketSearchRequest) GetFilters() []*MarketFilter {
	if x != nil {
		return x.Filters
	}
	return nil
...
type MarketFilter struct {
	...
	Operator  MarketFilter_Operator `protobuf:"varint,3,opt,name=operator,proto3,enum=proto.MarketFilter_Operator" json:"operator,omitempty"`
	Value     float32               `protobuf:"fixed32,4,opt,name=value,proto3" json:"value,omitempty"`
	Line      MarketFilter_Line     `protobuf:"varint,5,opt,name=line,proto3,enum=proto.MarketFilter_Line" json:"line,omitempty"`
}
...
func (x *MarketFilter) GetSelection() string {
	if x != nil {
		return x.Selection
	}
	return ""
...
func (x *MarketFilter) GetOperator() MarketFilter_Operator {
	if x != nil {
		return x.Operator
	}
	return MarketFilter_GTE
}

func (x *MarketFilter) GetValue() float32 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *MarketFilter) GetLine() MarketFilter_Line {
	if x != nil {
		return x.Line
	}
	return MarketFilter_CLOSING
}
...
var file_internal_grpc_proto_market_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x52,
	...
	0x22, 0xe6, 0x01, 0x0a, 0x0c, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x12, 0x1c, 0x0a, 0x09, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	0x38, 0x0a, 0x08, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x1c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	...
	,
	...
	,
	...
	0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x02, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x32, 0x4e, 0x0a,
	0x0d, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3d,
	0x0a, 0x0c, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x1a,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x53, 0x65, 0x61,
	0x72, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x22, 0x00, 0x30, 0x01, 0x42, 0x15, 0x5a,
...
var file_internal_grpc_proto_market_proto_goTypes = []interface{}{
	(MarketFilter_Operator)(0),   // 0: proto.MarketFilter.Operator
	(MarketFilter_Line)(0),       // 1: proto.MarketFilter.Line
	(*MarketSearchRequest)(nil),  // 2: proto.MarketSearchRequest
	(*MarketFilter)(nil),         // 3: proto.MarketFilter
...
var file_internal_grpc_proto_market_proto_depIdxs = []int32{
	3, // 0: proto.MarketSearchRequest.filters:type_name -> proto.MarketFilter
	...
	0, // 3: proto.MarketFilter.operator:type_name -> proto.MarketFilter.Operator
	1, // 4: proto.MarketFilter.line:type_name -> proto.MarketFilter.Line
